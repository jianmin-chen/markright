...
export default function Slug() {
    return (
        <div className="relative bg-neutral-100 flex flex-col gap-y-4 items-center justify-center min-h-screen pt-4">
            <Button
                variant="outline"
                className=" bg-white rounded-3xl px-14 py-1.5 shadow-lg hover:bg-white">
                Shared by Jianmin Chen
            </Button>
            <div className="border rounded-t-3xl bg-white shadow-2xl prose prose-lg max-w-none w-7/12 overflow-auto p-14">
                <p class="lead">
                ...
                <p>
                    ...
                    you spend less time undoing user-agent styles, but when you{" "}
                    <em>really are</em> just trying to style some content that
                    came from a rich-text editor in a CMS or a markdown file, it
                ...
                <p>
                    ...
                    have to remove annoying margins every time you use a{" "}
                    <code>p</code> element in a piece of your dashboard UI. And
                    I doubt you really want your blog posts to use the
                    user-agent styles either — you want them to look{" "}
                ...
                <p>
                    ...
                    any of the downsides of doing something stupid like
                    disabling our base styles.
                </p>
                <p>
                    It adds a new <code>prose</code> class that you can slap on
                    any block of vanilla HTML content and turn it into a
                ...
                <p>
                    ...
                    <strong>bold text</strong>, unordered lists, ordered lists,
                ...
                <p>
                    ...
                    <a href="https://prismjs.com/">Prism</a> or something if
                    they want to style their code blocks but it wouldn't hurt to
                    make them look <em>okay</em> out of the box, even with no
                    syntax highlighting.
                </p>
                <p>
                ...
                ß<p>Hopefully that looks good enough to you.</p>
                ...
                <p>
                    ...
                    <code>code</code> tag inside of a link, like if I wanted to
                    tell you about the{" "}
                    <a href="https://github.com/tailwindcss/docs">
                        <code>tailwindcss/docs</code>
                    </a>{" "}
                    repository. I don't love that there is an underline below
                    the backticks but it is absolutely not worth the madness it
                ...
                <p>
                    ...
                    heading levels for a reason, you animals. I honestly
                ...
                <p>
                    ...
                    <code>h4</code> elements are already so small that they are
                    the same size as the body copy. What are we supposed to do
                    with an <code>h5</code>, make it <em>smaller</em> than the
                    body copy? No thanks.
                </p>
